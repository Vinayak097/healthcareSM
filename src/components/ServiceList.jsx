...
function ServiceList({deleteService, services,setEditservice }) {
  const [editserve,seteditserve]=useState(null);
        ...
        <div key={service.id} className="bg-blue-50 p-4 w-72 border flex flex-col gap-4 justify-between rounded-lg">
          ...
          <div className="flex justify-between mb-1 ">
            ...
            <div className="flex gap-2">
              <button onClick={()=>{setEditservice(service)}} className="py-2 border-blue-300 hover:bg-blue-300 px-3 border rounded-full">Edit</button>
